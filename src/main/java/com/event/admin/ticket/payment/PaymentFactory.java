...
public class PaymentFactory {
    ...
    public PaymentFactory(JdbcTemplate jdbcTemplate) {
    ...
    public Payment createPayment(PaymentRequest paymentRequest) {
        if ("credit_card".equalsIgnoreCase(paymentRequest.getPaymentType())) {
            return createCreditCardPayment(paymentRequest);
        } else if ("bill".equalsIgnoreCase(paymentRequest.getPaymentType())) {
            return createBillPayment(paymentRequest);
        } else {
    ...
    public Payment createBillPayment(PaymentRequest paymentRequest) {
    ...
    public Payment createCreditCardPayment(PaymentRequest paymentRequest) {
        Payment payment;
        payment = new Payment();
